...
let priceSumWithoutKopeck = Math.floor(priceSweetmeats) + Math.floor(priceIceCream) + Math.floor(pricePie);

console.log("Округлення суми в меньшу сторону: ", priceSumWithoutKopeck );
document.writeln("Округлення суми в меньшу сторону: " + priceSumWithoutKopeck + " грн" + "<br>" + "<br>" );


//Виведіть суму товарів округлену до сотень. (Наприклад якщо вийшло 260, то виведіть 300):
console.log("Сума товарів, округлена до сотень: " + (Math.round(priceSumWithoutKopeck / 100) * 100)); //нагуглив :)
document.writeln("Сума товарів округлена до сотень: " + (Math.round(priceSumWithoutKopeck / 100) * 100) + " грн" + "<br>" + "<br>" );
